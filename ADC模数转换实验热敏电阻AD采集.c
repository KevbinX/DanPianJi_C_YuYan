...
注意事项：																				  
***************************************************************************************/
#include "public.h"	// 包含公共头文件
#include "smg.h"	// 包含七段数码管头文件
#include "xpt2046.h"	// 包含XPT2046触摸屏头文件
u8 flag;
...
void main() {
    ...
    while (1) {
        ...
        // 显示 ADC 值
        smg_display(adc_buf, 0); // 在数码管上显示ADC值
    }
}
